    ...
    <div className="p-4 text-zinc-100 mx-auto md:w-[40rem]">
      ...
      <div className="relative mb-6">
        ...
        <Search
          ...
          className="absolute cursor-pointer left-3 top-1/2 transform -translate-y-1/2 text-teal-200"
        />
      </div>
      ...
      <div className="space-y-4">
        ...
        {!isFetching &&
          ...
          barberShop.data?.map((barber) => (
            <div
              key={barber.id}
              className="bg-slate-100 rounded-lg p-4 flex gap-4 items-center text-gray-800"
            >
